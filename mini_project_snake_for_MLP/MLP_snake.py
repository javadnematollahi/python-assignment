...
class Eatfood():
    ...
    def eat_pear(self):
        ...
        out = self.game_class.model.predict([[
            self.food_up,self.food_down, self.food_left,self.food_right , self.dist_x_to_body,self.dist_y_to_body,
            800-self.game_class.snake.center_y, self.game_class.snake.center_y, self.game_class.snake.center_x,
            800-self.game_class.snake.center_x, self.game_class.pear.center_x, self.game_class.pear.center_y,
